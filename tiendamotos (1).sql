...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-03-2025 a las 21:10:19
...
(1000, 6000, 'AnDy', '', '0', '0', '', 30, 'GUANTE INGENIERO VAQUETA BLANCO REFUERZO PALMA'),
...
(2, 2, 3, NULL, NULL, 25000, 5, 0, 0, 125000),
(3, 2, 1024, NULL, NULL, 6000, 4, 0, 0, 24000),
(4, 2, 2, NULL, NULL, 3000, 9, 0, 0, 27000),
(5, 3, 2, NULL, NULL, 3000, 9, 0, 0, 27000);
